  ...
  return (
    <div className={`h-screen overflow-hidden flex flex-col transition-colors duration-200 ${isDarkMode ? 'bg-[#0F172A] text-slate-100' : 'bg-[#EDF2F7] text-gray-800'}`}>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className={`w-64 border-r flex flex-col py-6 shrink-0 z-20 transition-colors duration-200 ${isDarkMode ? 'bg-[#1E293B] border-slate-800' : 'bg-white border-gray-200'}`}>
          <nav className="flex flex-col gap-2 px-4">
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-colors text-left cursor-pointer ${isDarkMode ? 'text-slate-300 hover:bg-slate-800/80 hover:text-white' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'}`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-colors text-left cursor-pointer ${isDarkMode ? 'text-slate-300 hover:bg-[#1E293B] hover:text-white' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'}`}
            >
            ...
            <div>
              ...
              >
                ...
                <i className={`fa-solid fa-chevron-${isReportOpen ? 'down' : 'right'} text-xs transition-transform duration-200`}></i>
              </button>
              ...
              {isReportOpen && (
                <div className={`ml-4 pl-3 border-l-2 mt-1 flex flex-col gap-1 ${isDarkMode ? 'border-slate-700' : 'border-gray-200'}`}>
                  ...
                  >
                    <i className="fa-solid fa-list-check w-4 text-center"></i> Generate Report
                  </button>
                  <button
                  ...
                  >
                    <i className="fa-solid fa-file-excel w-4 text-center"></i> Export Excel
                  </button>
                </div>
              )}
            </div>
            ...
            {canManageUsers && (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-colors text-left cursor-pointer ${isDarkMode ? 'text-amber-400 hover:bg-slate-800/80 hover:text-amber-300' : 'text-amber-600 hover:bg-amber-50 hover:text-amber-700'}`}
              >
        ...
        {/* MAIN CONTENT AREA */}
        <main className={`flex-1 overflow-y-auto p-8 ${isDarkMode ? 'bg-[#0F172A]' : 'bg-[#EBF1F7]'}`}>
          {activeReportTab === 'export' ? (
            /* EXPORT EXCEL */
