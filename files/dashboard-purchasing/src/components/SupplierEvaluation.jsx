...
import { 
  ...
  XCircle, Crown, Star, Upload, ChevronDown, Database, Trash2
} from 'lucide-react';
import { useRole } from '../context/RoleContext';
import AppLayout from './AppLayout'; // Pastikan path import sesuai dengan struktur folder Anda
...
export default function SupplierEvaluationDashboard({ changePage: propChangePage, onLogout, activePage: propActivePage = 'supplierEvaluation' }) {
  ...
  // Handle Klik di Luar Clear Dropdown
  useEffect(() => {
